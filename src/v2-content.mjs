...
const useIndex = { path: "/use-cases", type: "CollectionPage", kind: "use-index", title: "Business Use Cases | Muhammad Haris Aslam", description: "Business models and transformation cases across banking, commerce, retail, payments, logistics, enterprise technology, AI and GCC market entry.", eyebrow: "Use cases", h1: "Business problems turned into operating models", intro: "Each case connects the problem to commercial logic, technology, operating design and measurable value.", v3: true, v3Body: v3UseLibrary(expandedLibraryCases), body: "" };
...
const privacy = {
  ...
  type: "WebPage",
  kind: "privacy",
  title: "Privacy Policy | Muhammad Haris Aslam",
  description: "Privacy policy for mharisaslam.com and the Haris Content Publisher LinkedIn publishing workflow.",
  eyebrow: "Privacy",
  h1: "Privacy policy",
  intro: "How information is handled on mharisaslam.com and within the Haris Content Publisher workflow.",
  body: `
    ${section("Scope", `<div class="report-prose"><p>This privacy policy applies to mharisaslam.com and to Haris Content Publisher, a private content-publishing workflow used by Muhammad Haris Aslam to prepare and publish approved content to LinkedIn.</p><p>The workflow is intended for content owned or approved by Muhammad Haris Aslam. It is not designed to collect or sell personal information from visitors.</p></div>`)}
    ${section("Information that may be processed", `<div class="report-prose"><p>The website may receive standard technical information generated when a visitor uses the site, such as browser, device, page and referral information through ordinary website analytics.</p><p>When LinkedIn is connected to Haris Content Publisher, the workflow may process the LinkedIn account identifiers and authorization tokens required to authenticate the account and publish content that has been approved for posting. The workflow may also process the text, links, images or documents selected for publication.</p><p>LinkedIn account passwords are not collected or stored by this website or publishing workflow.</p></div>`)}
    ${section("How the information is used", `<div class="report-prose"><p>Information is used only to operate and secure the website, understand aggregate site usage, authenticate authorized publishing connections, prepare approved content and publish that content to the connected LinkedIn account.</p><p>Personal information is not sold to advertisers or data brokers.</p></div>`)}
    ${section("LinkedIn authorization", `<div class="report-prose"><p>LinkedIn access is granted through LinkedIn's own authorization process. Where publishing permission is enabled, the connection is used only for actions permitted by the account holder.</p><p>Authorization can be withdrawn through LinkedIn account settings or by contacting the address below. Revoking access prevents future use of the associated authorization token.</p></div>`)}
    ${section("Data storage and security", `<div class="report-prose"><p>Access credentials and authorization tokens used by the publishing workflow are intended to be stored in protected server-side environment variables rather than exposed in public website code. Reasonable technical measures are used to restrict access to those credentials.</p><p>Information is retained only for as long as reasonably necessary to operate the relevant website or publishing function, meet security needs, or comply with applicable legal obligations.</p></div>`)}
    ${section("Third-party services", `<div class="report-prose"><p>The website and publishing workflow may rely on third-party infrastructure and services such as LinkedIn, Vercel and website analytics providers. Those services process information under their own terms and privacy policies.</p><p>Haris Content Publisher is an independent publishing workflow and is not endorsed by or affiliated with LinkedIn Corporation.</p></div>`)}
    ${section("Your choices", `<div class="report-prose"><p>You may request information about personal data associated with this website, request correction or deletion where applicable, or request that a publishing authorization be revoked.</p><p>For privacy questions or requests, contact <a href="mailto:haris@mharisaslam.com">haris@mharisaslam.com</a>.</p></div>`)}
    ${section("Updates", `<div class="report-prose"><p>This policy may be updated when the website, publishing workflow or applicable requirements change. The effective date of this version is 20 September 2026.</p></div>`)}
  `
};
...
export const pages = [home, trackIndex, ...trackRecords.map(trackPage), useIndex, ...existingCasePages, ...addedCasePages, aiPage, insightsPage, ...insights.map(articlePage), about, privacy, contact];
