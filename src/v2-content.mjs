...
export const pages = [home, trackIndex, ...trackRecords.map(trackPage), useIndex, ...existingCasePages, ...addedCasePages, aiPage, insightsPage, ...insights.map(articlePage), about, contact];
