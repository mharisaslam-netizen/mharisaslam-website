...
export const pages = [
  ...
  },
  {
    ...
    eyebrow: "Ventures · Entrepreneur-in-Residence",
    ...
    body: `
      ...
      ${section("A strong EIR brief", "The fit is strongest when an organisation has an advantage to unlock—not only an idea to discuss.", cards([
        ...
        { title: "Marketplace or platform", text: "The opportunity depends on supply, demand and operational orchestration—not software alone." },
