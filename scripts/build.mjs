...
function breadcrumbItems(path) {
  ...
  const hubLabels = { "/gcc-growth-transformation":"GCC Growth & Transformation", "/gcc-executive-profile":"Executive Profile", "/track-record":"Track Record", "/use-cases":"Use Cases", "/ai-transformation":"AI & Transformation", "/insights":"Insights", "/markets/uae":"UAE Growth & Transformation", "/markets/saudi-arabia":"Saudi Arabia Growth & Market Entry" };
