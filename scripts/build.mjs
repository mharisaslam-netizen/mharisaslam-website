...
<head>
  ...
  <meta name="theme-color" content="${page.v3 ? "#f4f0e7" : "#ffffff"}">
  <link rel="stylesheet" href="/assets/site.css">
  <link rel="stylesheet" href="/assets/v3-pilot.css">
  <link rel="icon" href="/assets/favicon.png" type="image/png">
  <script type="application/ld+json">${safeJson(schema)}</script>
</head>
<body${page.v3 ? ` class="v3-page v3-${page.kind}"` : ""}>
  <a class="skip-link" href="#main">Skip to content</a>
  ${header(page.path)}
  ${crumbs.length > 1 && !page.v3 ? breadcrumbs(crumbs) : ""}
  <main id="main">
    ${page.v3 ? page.v3Body : `<header class="hero${page.heroAside ? "" : " hero-single"}">
